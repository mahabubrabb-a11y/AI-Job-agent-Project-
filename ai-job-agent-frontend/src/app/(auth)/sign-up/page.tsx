...
export default function SignUpPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-[#070A12] text-slate-100 overflow-hidden px-4 font-sans selection:bg-blue-600 selection:text-white">
      ...
      {/* 1. Main Glow behind Sign Up Card */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-tr from-indigo-600/20 via-blue-500/15 to-emerald-600/20 blur-[130px] rounded-full pointer-events-none z-0" />

      {/* 2. Top Secondary Ambient Light */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[250px] bg-indigo-500/10 blur-[100px] pointer-events-none z-0" />
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-slate-900/60 backdrop-blur-xl rounded-2xl border border-slate-800/90 shadow-[0_0_40px_rgba(0,0,0,0.6)]">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-slate-400 mt-1">
            Join thousands of developers automating their career
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-950/70 border border-slate-800 rounded-xl text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/50 transition-all"
                required
              />
            </div>
          </div>
        ...
        <div className="mt-6 text-center text-xs text-slate-400">
          ...
          <Link href="/sign-in" className="text-blue-400 hover:text-blue-300 font-semibold underline underline-offset-4 transition-colors">
            Sign In
          </Link>
        </div>
      </div>
